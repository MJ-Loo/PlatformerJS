...
export class Corridor{
  ...
  createCorridor() {
      ...
      this.StaticPlatforms([12, 30, 0.2], [this.x+11, this.y+5, this.z+24] ,[0,0,0],'Cwalllong.jpg2');    
      ...
      this.StaticPlatforms([0.2, 30, 68], [this.x+17, this.y, this.z+58],[0,0,0] ,'Cwalllong.jpg2');
